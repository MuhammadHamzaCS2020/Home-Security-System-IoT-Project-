...
<head>
	...
	<title>Computer Networking | Humidity</title>
      ...
      var chart = c3.generate({
        ...
        data: {
          ...
          //$query="select * from sensorValues order by dateTime ASC";
              $query1 = "select Humidity from sensorValues";
              $row1 = mysqli_query($conn, $query1);
              $counter=7;
              for ($i=0; $i <$counter; $i++) {
                $values1 = mysqli_fetch_array($row1);
                echo $values1['Humidity'];
                echo ',';
              }
             ?>]
          ],
			...
			<div class="my-3 my-md-5">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Humidity Graph</h3>
                </div>
                <div class="card-body">
						...
						<div class="col-lg-8">
							<div class="card">
								<form action="#" method="post" class="card">
									<div class="card-header">
										<h3 class="card-title">Humidity (Values)</h3>
									</div>
									<div class="card-body">
										<div class="row">
											<div class="col-md-12 col-lg-12">
